...
import bridgwatercarnival.composeapp.generated.resources.Chatbot
import bridgwatercarnival.composeapp.generated.resources.Chatbot_chaticon
...
private fun NavButton(
	...
	val rippleColor = color.copy(alpha = 0.2f)
	val iconTint = if (MaterialTheme.colors.isLight) {
		Color.Black
	} else {
		Color.White
...
fun Help(onNavigate: (PageIndex) -> Unit) {
	...
	LaunchedEffect(Unit) {
		while (true) {
			...
			val target = LocalDateTime(2025, 11, 1, 18, 0)
	...
	Column(
		...
		ExpandableCategory(
			...
			Row(
				...
				NavButton(
					...
					onClick = { onNavigate(PageIndex.DAYTIME_ENTERTAINMENT) },
		...
		ExpandableCategory(
			...
			Row(
				...
				NavButton(
					PageIndex.NEWS,
					TranslationManager.translate("help_news_title"),
					Res.drawable.news,
					onClick = { onNavigate(PageIndex.NEWS) },
					color = ThemeColors.additionalButton(isLight),
					textColor = Color.Black,
					textSize = 20.sp,
					iconSize = 25.dp
				...
				NavButton(
					PageIndex.CHATBOT,
					"AI Assistant",
					Res.drawable.Chatbot,
					onClick = { onNavigate(PageIndex.CHATBOT) },
					color = ThemeColors.additionalButton(isLight),
					textColor = Color.Black,
					textSize = 20.sp,
					iconSize = 25.dp
